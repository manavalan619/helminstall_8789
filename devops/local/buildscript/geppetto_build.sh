...
DESKTOPCODE='../../../application/client/desktop/helminstall_8789'
DESKTOPIMAGENAME='geppettotest/helminstall_8789-desktop:1.0'
...
helm install --name helminstall-8789 ./helm
if [ $? -eq 0 ]; then
